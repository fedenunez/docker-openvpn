...
Generate server configuration with the udp6 or tcp6 protocol:
    ...
    docker run -v $OVPN_DATA:/etc/openvpn --rm fedenunez/openvpn ovpn_genconfig -u udp6://VPN.SERVERNAME.COM
    docker run -v $OVPN_DATA:/etc/openvpn --rm fedenunez/openvpn ovpn_genconfig -u tcp6://VPN.SERVERNAME.COM
